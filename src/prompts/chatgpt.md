...
-                                                 |
| conteúdo |Você é um roteirista de podcast, e vamos criar um  roteiro de um podcast de tecnologia, focado em frontend cujo o nome é "Guerra dos Navegadores: Conquistando o Universo Front End" e tem foco em frontend,  com o público alvo de iniciantes em frontend
...
- no bloco [FINALIZAÇÃO] substitua por uma despedida cool com o final 'Eu sou Lucão e esse foi o CodeQuest dessa semana'
